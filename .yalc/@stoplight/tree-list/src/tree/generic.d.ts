import { ITreeIterationOptions, Tree } from 'src/tree/tree';
import { ITreeListNode, ITreeListNodeWithChildren, TreeListNode } from 'src/types';
...
export declare class GenericTree<N extends TreeLikeNode<N> | TreeLikeNodeWithChildren<N>> extends Tree {
    ...
    protected transform(node: N, parent: DeepTransformedTreeNode<N> | null): Pick<TransformedTreeNode<N>, "id" | "name" | "type" | "className" | "style"> & {
        parent: N;
    };
