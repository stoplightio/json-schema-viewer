...
function getDeprecatedValue(node: JSONSchema): Optional<boolean> {
...
function getTypeValidations(type: NonNullable<JSONSchema['type']>): string[] {
...
export const getValidations = (node: JSONSchema): Dictionary<unknown> => {
