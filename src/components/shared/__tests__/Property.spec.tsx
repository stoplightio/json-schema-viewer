...
describe('Property component', () => {
  ...
  describe('properties names', () => {
    ...
    it('given an object among other types, should still display its properties', () => {
      ...
      const wrapper = render(schema, ['properties', 'foo']);
      expect(wrapper.find(SchemaRow).html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-relative\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-baseline sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-semibold\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">array of integers</span></div></div></div></div><div></div></div></div>"`,
      );
    });
    ...
    it('given an array of objects, should display names of those properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\"><div class=\\"sl-relative\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-baseline sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-semibold\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div></div>"`,
      );
    });
    ...
    it('given an array with an allOf inside and enabled allOf merging, should display the name of properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\"><div class=\\"sl-relative\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-baseline sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-semibold\\">bar</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div></div>"`,
      );
    });
