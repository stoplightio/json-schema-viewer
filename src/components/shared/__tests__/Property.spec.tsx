  ...
  describe('properties names', () => {
    it('given an object, should display the names of its properties', () => {
      ...
      expect(wrapper.find(SchemaRow).html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div>"`,
      );
    });
    ...
    it('given an object among other types, should still display its properties', () => {
      ...
      const wrapper = render(schema, ['properties', 'foo']);
      expect(wrapper.find(SchemaRow).html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">array of integers</span></div></div></div></div><div></div></div></div>"`,
      );
    });
    ...
    it('given an array of objects, should display names of those properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\"><div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div></div>"`,
      );
    });
    ...
    it('given an array with a mergeable combiner inside, should merge it', () => {
      ...
      const wrapper = render(schema);
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\"><div class=\\"sl-text-sm sl-relative\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"sl-cursor-pointer\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-absolute sl-justify-center sl-p-1 sl-cursor-pointer sl-text-muted\\" style=\\"width: 20px; height: 20px; position: relative; left: -7px;\\" role=\\"button\\"><svg aria-hidden=\\"true\\" focusable=\\"false\\" data-prefix=\\"fas\\" data-icon=\\"chevron-down\\" class=\\"svg-inline--fa fa-chevron-down fa-w-14 fa-xs sl-icon\\" role=\\"img\\" xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 448 512\\"><path fill=\\"currentColor\\" d=\\"M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z\\"></path></svg></div><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><span class=\\"sl-truncate sl-text-muted\\">array of objects</span></div></div></div></div><div></div></div><div><div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">foo</div></div></div></div></div><div></div></div></div><div class=\\"sl-border-t sl-self-stretch\\"></div><div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">bar</div></div></div></div></div><div></div></div></div><div class=\\"sl-border-t sl-self-stretch\\"></div><div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">baz</div></div></div></div></div><div></div></div></div></div></div></div>"`,
      );
    });
    ...
    it('given an array with an allOf inside and enabled allOf merging, should display the name of properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\"><div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">bar</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div></div>"`,
      );
    });
    ...
    it('given a ref pointing at complex type, should display property name', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-text-sm sl-relative\\" style=\\"margin-left: 20px;\\"><div class=\\"sl-flex\\"><div class=\\"sl-min-w-0 sl-flex-grow\\"><div class=\\"\\"><div class=\\"sl-flex sl-items-center sl-my-2\\"><div class=\\"sl-flex sl-items-center sl-text-base sl-flex-1\\"><div class=\\"sl-mr-2 sl-font-mono sl-font-bold\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">object</span></div></div></div></div><div></div></div></div>"`,
      );
      wrapper.unmount();
    });
  });
