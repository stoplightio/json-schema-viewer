  ...
  describe('properties names', () => {
    it('given an object, should display the names of its properties', () => {
      ...
      expect(wrapper.find(SchemaRow).html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div>"`,
      );
    });
    ...
    it('given an object among other types, should still display its properties', () => {
      ...
      const wrapper = render(schema, ['properties', 'foo']);
      expect(wrapper.find(SchemaRow).html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">array[integer]</span></div></div></div></div><div></div></div></div>"`,
      );
    });
    ...
    it('given an array of objects, should display names of those properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\" id=\\"mosaic-provider-react-aria-0-1\\"><div data-overlay-container=\\"true\\" class=\\"\\"><div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div></div></div>"`,
      );
    });
    ...
    it('given an array with a mergeable combiner inside, should merge it', () => {
      ...
      const wrapper = render(schema);
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\" id=\\"mosaic-provider-react-aria-0-1\\"><div data-overlay-container=\\"true\\" class=\\"\\"><div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div class=\\"sl-cursor-pointer\\"><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-justify-items-center sl-items-center sl-absolute sl--left-6 sl-h-3 sl-mt-0.5 sl-text-muted sl-cursor-pointer\\" role=\\"button\\"><svg aria-hidden=\\"true\\" focusable=\\"false\\" data-prefix=\\"fas\\" data-icon=\\"chevron-down\\" class=\\"svg-inline--fa fa-chevron-down fa-w-14 fa-xs sl-icon\\" role=\\"img\\" xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 448 512\\"><path fill=\\"currentColor\\" d=\\"M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z\\"></path></svg></div><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><span class=\\"sl-truncate sl-text-muted\\">array[object]</span></div></div></div></div><div></div></div><div class=\\"sl-text-sm sl-pl-6\\"><div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div></div></div></div></div><div></div></div></div><div class=\\"sl-self-stretch sl-border-light sl-border-t\\"></div><div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">bar</div></div></div></div></div><div></div></div></div><div class=\\"sl-self-stretch sl-border-light sl-border-t\\"></div><div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">baz</div></div></div></div></div><div></div></div></div></div></div></div></div>"`,
      );
    });
    ...
    it('given an array with an allOf inside and enabled allOf merging, should display the name of properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\" id=\\"mosaic-provider-react-aria-0-1\\"><div data-overlay-container=\\"true\\" class=\\"\\"><div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">bar</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div><div></div></div></div></div></div>"`,
      );
    });
    ...
    it('given a ref pointing at complex type, should display property name', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-relative\\"><div class=\\"sl-flex sl-max-w-full\\"><div class=\\"sl-flex-grow sl-max-w-full\\"><div><div class=\\"sl-flex sl-items-center sl-max-w-full sl-my-2\\"><div class=\\"sl-flex sl-flex-1 sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">object</span></div></div></div></div><div></div></div></div>"`,
      );
      wrapper.unmount();
    });
  });
