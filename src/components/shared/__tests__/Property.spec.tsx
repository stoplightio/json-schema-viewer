  ...
  describe('properties names', () => {
    it('given an object, should display the names of its properties', () => {
      ...
      expect(wrapper.find(SchemaRow).html()).toMatchInlineSnapshot(
        `"<div class=\\"sl-flex sl-max-w-full sl-py-2\\"><div class=\\"sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full\\"><div class=\\"sl-flex sl-items-center sl-max-w-full\\"><div class=\\"sl-flex sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div>"`,
      );
    });
    ...
    it('given an array of objects, should display names of those properties', () => {
      ...
      expect(wrapper.html()).toMatchInlineSnapshot(
        `"<div class=\\"\\" id=\\"mosaic-provider-react-aria-0-1\\"><div data-overlay-container=\\"true\\" class=\\"\\"><div class=\\"sl-flex sl-max-w-full sl-py-2\\"><div class=\\"sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full\\"><div class=\\"sl-flex sl-items-center sl-max-w-full\\"><div class=\\"sl-flex sl-items-baseline sl-text-base\\"><div class=\\"sl-font-mono sl-font-semibold sl-mr-2\\">foo</div><span class=\\"sl-truncate sl-text-muted\\">string</span></div></div></div></div></div></div>"`,
      );
    });
