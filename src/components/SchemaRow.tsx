  ...
  return (
    <div className="px-2 flex-1 w-full">
      ...
      >
        ...
        {schemaNode.divider && (
          <div className="flex items-center w-full absolute" style={{ top: -9, height: 1, left: -15 }}>
            <div className="text-darken-7 dark:text-lighten-7 pr-2 uppercase text-xs">{schemaNode.divider}</div>
